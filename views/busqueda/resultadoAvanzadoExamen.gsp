						...
						<div class="row">
							...
							<div class="col-sm-6">
								<select id="sel1" class="event-type-select2 eb">
									<option value="semestre">Periodo</option>
		...
		<div class="container">
			...
			<div class="row">
				<div class="container-box">
					<g:each in="${listado }" var="examen" status="i">
						<div id="ex" class="box reb ide" data-semestre="${examen.periodo}" data-parcial="${examen.parcial}" data-profesor="${examen.profesor }">
							<div class="box-head">
								<b>${examen.periodo }</b>
								<p>${examen.parcial }</p>
							</div>
							<div class="box-body">
								<p>
									<strong>Profesor: </strong>${examen.profesor }</p>
								<p>
									<strong>Fecha: </strong>${examen.fecha }</p>
							</div>
							<div class="box-footer">
								<g:if test="${examen.archivos != null && examen.archivos.length>0 }">
									<hr title="Visualice el contenido" onclick="window.location='vistaDocu?ruta=${examen.archivos[0].urlVisualizacion }&nombre=${examen.nombre }&curso=${examen.curso }&periodo=${examen.periodo }&parcial=${examen.parcial }&profesor=${examen.profesor }&fecha=${examen.fecha }&tipo=examen';">
								</g:if>
								<g:else>
									<hr class="no-eye">
								</g:else>
